...
# def adminsignup_view(request):
#     form=forms.AdminSigupForm(request.POST or None)
#     if form.is_valid():
#         form.save()
#         form = adminsignup_view()
#     context = {
#         'form': form
#     }
#     return render(request,"library/adminsignup.html",context)
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            send_mail(str(name)+' || '+str(email),message, EMAIL_HOST_USER, ['my7mailacc@gmail.com'], fail_silently = False)
